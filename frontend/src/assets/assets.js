...
import Srikanth_img from './Srikanth_img.jpg';
import Rishitha_img from './Rishitha_img.jpg';
import Ramya_img from './Ramya_img.jpg';
...
export const products = [
    {
        _id: "bbbbb",
        name: "Eco-Friendly Women's Organic Cotton Top",
        description: "Crafted from 100% organic cotton, this lightweight and breathable top combines comfort with sustainability. Featuring a classic round neckline and short sleeves, it’s perfect as a standalone piece or a layering essential.",
        price: 59,
        image: [p_img1], // Replace 'p_img1' with the actual image reference
        category: "Women",
        subCategory: "Sustainable Topwear",
        sizes: ["XS", "S", "M", "L", "XL"], // Added extra size for inclusivity
        date: Date.now(), // Automatically sets the current timestamp
        bestseller: true,
        features: [
            "100% GOTS-certified organic cotton",
            "Lightweight and breathable fabric",
            "Eco-friendly dyes with zero harmful chemicals",
